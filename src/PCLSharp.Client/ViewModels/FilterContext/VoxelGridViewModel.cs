...
namespace PCLSharp.Client.ViewModels.FilterContext
{
    ...
    /// 体素降采样视图模型
    /// </summary>
    public class VoxelGridViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public VoxelGridViewModel(ICloudCommon cloudCommon, ICloudFilters cloudFilters)
            : base(cloudCommon)
        {
        ...
        public async void Apply()
        {
            ...
            Point3F[] filterdPoints = await Task.Run(() => this._cloudFilters.ApplyVoxelGrid(points, this.LeafSize!.Value));
