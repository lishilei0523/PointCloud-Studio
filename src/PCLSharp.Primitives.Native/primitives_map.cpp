...
/// <param name="length">长度</param>
/// <returns>点云</returns>
PointCloud<PointNormal> pclsharp::toPointCloud(Point3Normal3 point3Normal3s[], const int& length)
{
...
/// <param name="length">长度</param>
/// <returns>点云</returns>
PointCloud<PointXYZRGBA> pclsharp::toPointCloud(Point3Color4 point3Color4s[], const int& length)
{
	PointCloud<PointXYZRGBA> pointColors;
	for (int i = 0; i < length; i++)
	{
