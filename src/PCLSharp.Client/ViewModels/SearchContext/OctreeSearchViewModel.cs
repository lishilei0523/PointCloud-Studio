...
namespace PCLSharp.Client.ViewModels.SearchContext
{
    ...
    /// 八叉树搜索视图模型
    /// </summary>
    public class OctreeSearchViewModel : PreviewViewModel
    {
        #region # 字段及构造器
        ...
        /// 依赖注入构造器
        /// </summary>
        public OctreeSearchViewModel(ICloudCommon cloudCommon, ICloudSearch cloudSearch)
            : base(cloudCommon)
        {
        ...
        public async void Apply()
        {
            ...
            Point3F[] keyPoints = await Task.Run(() => this._cloudSearch.OctreeSearch(points, referencePoint, this.Resolution!.Value));
