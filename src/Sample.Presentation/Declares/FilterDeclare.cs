...
namespace Sample.Presentation.Declares
{
    /// <summary>
    /// 点云滤波声明
    /// </summary>
    public static class FilterDeclare
    {
        ...
        [DllImport("Sample.PCL.Filters.dll", EntryPoint = "applyPassThrogh")]
        ...
        /// <returns>过滤后点集</returns>
        [DllImport("Sample.PCL.Filters.dll", EntryPoint = "applyUniformSampling")]
        ...
        /// <returns>过滤后点集</returns>
        [DllImport("Sample.PCL.Filters.dll", EntryPoint = "applyVoxelGrid")]
        ...
        /// <returns>过滤后点集</returns>
        [DllImport("Sample.PCL.Filters.dll", EntryPoint = "applyOutlierRemoval")]
        ...
        [DllImport("Sample.PCL.Filters.dll", EntryPoint = "dispose")]
